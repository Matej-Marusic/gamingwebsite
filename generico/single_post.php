            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-10 p-3 bg-black">
                        <!-- sredinski del strani -->
                        <div class="card-post">
                            <?php echo $fetch_singlePost->title; ?>
                            <?php echo $fetch_singlePost->content; ?>
                        </div>
                        <button type="button" class="btn btn-wideback" onclick="history.back()">&#8592;</button>
                    </div>
                </div>
            </div>
        </main>
